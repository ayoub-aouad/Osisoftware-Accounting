    ...
    def _get_account_values(self, options, account_ids,
        ...
        if date:
            ...
            if period_fiscal_year:
                ...
                where_params[4] = date_to
                where_params[5] = date_from
        ...
        for col in list_columns:
            ...
            if 'no_format_name' in new_col:
                ...
                if view_type == 'reversed':
                    ...
                    new_name = abs(value) * -1
            if new_value != value:
                new_col.update(no_format_name=new_value)
            if new_name != name:
                new_col.update(name=self.format_value(new_name))
            res.append(new_col)
        return res
